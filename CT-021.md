...
$$p_{\text{abs}} = p_{\text{atm}} + p_{\text{gauge}} = 101.325\text{ kPa} - 9.325\text{ kPa} = 92.000\text{ kPa (Abs)}$$
...
$$\sigma = \frac{p_{\text{abs}} - p_{\text{vapor}}}{\frac{1}{2}\rho V^2}$$

The local static cavitation safety margin $\Delta p_{\text{margin}}$ is calculated strictly as:

$$\Delta p_{\text{margin}} = p_{\text{abs}} - p_{\text{vapor}} = 92.000\text{ kPa} - 27.200\text{ kPa} = 64.800\text{ kPa}$$
...
$$\Delta p_{\text{margin, transient}} = 92.000\text{ kPa} - 70.000\text{ kPa} = 22.000\text{ kPa}$$

When combined with localized dynamic pressure drops ($\Delta p_{\text{dynamic}} > 25\text{ kPa}$) through micro-channel constrictions:

$$p_{\text{local, abs}} = p_{\text{abs}} - \Delta p_{\text{dynamic}} = 92.000\text{ kPa} - 25.000\text{ kPa} = 67.000\text{ kPa} < p_{\text{vapor}} (70.000\text{ kPa})$$

$$\implies \text{Local Cavitation Inception + Instant Vapor-Locking}$$
